...
cc_cvname = "gs://neuroglancer/pinky40_v11/mito_test"
...
# TEST VOLUME COORDS
start_coord = (36864, 26112, 0)
vol_shape   = (4096, 4096, 1024)
chunk_shape = (2048, 2048, 1024)
...
proc_dir_path = "gs://neuroglancer/nick/mito_test/"
# =============
...
def merge_overlaps(dag):
    return DockerWithVariablesOperator(
        ...
        mount_point="/root/.cloudvolume/secrets",
        bash_command=(f"merge_overlaps {proc_dir_path}"),
        default_args=default_args,
        image="seunglab/synaptor:latest",
        queue="cpu",
        dag=dag)
