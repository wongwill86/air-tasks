...
CHUNKGRAPH_DAG_ID = 'chunkedgraph_edgetask_scheduler'
...
def create_edge_task(dag, c, x, y, z):
    p = '{} {} {} {} {}-{}_{}-{}_{}-{}'.format(
                    c['watershed_path'], c['agglomeration_path'],
                    c['regiongraph_path'], c['output_path'],
                    x - c['low_overlap'],
    ...
    t = DockerWithVariablesOperator(
        ...
        command='julia /usr/local/chunked-graph/src/tools/graphgen/edgetask.jl %s' % p,
        default_args=default_args,
